...
class WalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create walk" do
    assert_difference('Walk.count') do
      post walks_url, params: { walk: { dog_id: @walk.dog_id, status: @walk.status, walker_id: @walk.walker_id } }
    end
  ...
  test "should update walk" do
    patch walk_url(@walk), params: { walk: { dog_id: @walk.dog_id, status: @walk.status, walker_id: @walk.walker_id } }
